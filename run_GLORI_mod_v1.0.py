...
def run_command(file,combine,untreated,rvs_fac,Threads):
    ...
    file7_2 = outputprefix + "_merged.sorted.bam"  # merged, sorted, final bam
    ...
    mapping_1 = "python "+NStoolsdir+"mapping_reads_v1.0.py -q "+ file +" -p "+ Threads + " -f "+ genome+ ' --FilterN '+FilterN
